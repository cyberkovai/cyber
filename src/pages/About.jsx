...
import companylogo2 from "../assets/images/wad-logo.png";
import companylogo3 from "../assets/images/ihracsjc-logo.png";
                ...
                <div className="who-we-are-content mb-5">
                    ...
                    <div className="who-we-are-counters">
                        ...
                        <div className="row mt-5">
							...
							<h3  className="wow fadeInUp mb-3" data-wow-delay="0.2s" style="font-size:22px;" data-cursor="-opaque">Licensed & <span> Certified Investigation </span> Associations</h3>
                                <div className="col-3">
                                    <figure className="image-anime">
